<template>
  <v-ons-page class='settings'>
    ...
    <v-ons-list-item>
      ...
      <div class='right'>
        <v-ons-switch input-id='adultFilter'
                      v-model='settings.adultFilter'
                      modifier='material'
        ></v-ons-switch>
      </div>
    </v-ons-list-item>
    ...
    <v-ons-list-item>
      ...
      <div class='right'>
        <v-ons-select modifier='' style='width: 90%'
                      v-model='settings.language[0]'
        >
    ...
    <v-ons-list-item>
      ...
      <div class='right'>
        <v-ons-range v-model='tempResultsPerPage'
                     style='width: 100%;'
                     modifier='material'
        ></v-ons-range>
      </div>
